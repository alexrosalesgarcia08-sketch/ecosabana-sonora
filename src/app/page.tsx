...
export default function LoginPage() {
  ...
  async function handleLogin() {
    ...
    if (u?.rol === 'admin') router.push('/admin')
  ...
  async function handleRegister() {
    ...
    // Insertar en tabla usuarios como 'usuario'
    if (data.user) {
        ...
        <div className="card-body">
          {modo === 'login' ? (
            <>
              ...
              {exito && <div style={{background:'rgba(0,177,90,.12)',border:'1.5px solid #00B15A',borderRadius:'12px',padding:'12px',marginBottom:'14px',fontSize:'13px',color:'#2e4a08',fontWeight:700}}>{exito}</div>}
              ...
              {error && <p style={{color:'#EF4135',fontSize:'12px',marginBottom:'8px',fontWeight:700}}>{error}</p>}
            ...
            <>
              ...
              <div className="register-panel open" style={{padding:'0',border:'none',marginTop:'0',animation:'none'}}>
                ...
                {error && <p style={{color:'#EF4135',fontSize:'12px',marginTop:'8px',fontWeight:700}}>{error}</p>}
